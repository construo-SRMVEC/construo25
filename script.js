...
if (copyLinkButton && navigator.clipboard) {
  copyLinkButton.addEventListener("click", () => {
    navigator.clipboard.writeText("www.construo2k.vercel.app/").then(() => {
...
if (bridgeImage) {
  bridgeImage.addEventListener("mousedown", () => {
    holdTimeout = setTimeout(() => {
      if (modalImage && modal && downloadButton && bridgeImage.src) {
...
if (closeModalButton && modal && downloadButton) {
